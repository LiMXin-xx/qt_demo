...
#include <memory>
#include "../../../../main/include/main/uimainwindow.h"
...
QT_MOC_LITERAL(1, 13, 11), // "backToLogin"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "UiMainWindow\0backToLogin\0"
};
...
void UiMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (UiMainWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UiMainWindow::backToLogin)) {
                *result = 0;
                return;
            }
        }
